# AGENTS.md — Instrucciones para agentes en lifetrack-local

Este archivo configura el comportamiento de Codex en el proyecto LifeTrack-local.
...
Carpeta: `.Codex/skills/` — **21 skills** instaladas (suite completa addyosmani/agent-skills).
Carpeta: `.Codex/agents/` — 3 personas (code-reviewer, test-engineer, security-auditor).
Carpeta: `.Codex/references/` — 5 checklists (testing, security, performance, accessibility, orchestration).

Skills se activan por triggers en su frontmatter `description`. NO hay que invocarlas manualmente — Codex las descubre por contexto.
...
- Generar tests boilerplate (Codex revisa)
- Drafts de commits/PRs

**Codex (yo) reservado para:**
...
Roberto, espanol, nuevo en Codex. Explicar paso-a-paso. No asumir conocimiento. Maxima automatizacion del lado del agente.
